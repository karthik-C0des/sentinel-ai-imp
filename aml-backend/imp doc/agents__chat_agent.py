...
from services.agents.tools.entity_tools import get_entity_profile, screen_watchlists, indian_watchlist_screen
...
CHAT_SYSTEM_PROMPT = """\
You are SentinelAI, a senior AML/KYC investigation co-pilot for risk analysts \
...
ALL_TOOLS = [
    ...
    screen_watchlists,
    indian_watchlist_screen,   # Indian regulatory watchlist (MHA/UAPA/ED/SEBI/RBI/I4C)
    search_typologies,
    lookup_typology,
    search_compliance_policies,
    search_investigations,
