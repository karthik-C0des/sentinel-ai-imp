...
async def get_entity_transactions(
    ...
    try:
        ...
        # If no transactions found, return empty result (not a 404 error)
        # Frontend will handle the empty state gracefully
...
async def get_entity_transaction_network(
    ...
    try:
        ...
        # If no network found, return empty result (not a 404 error)
        # Frontend will handle the empty state gracefully
