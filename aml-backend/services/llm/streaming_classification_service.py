...
class StreamingClassificationService:
    ...
    async def classify_entity_stream(self, workflow_data: Dict[str, Any], 
        ...
        try:
            ...
            # Phase 2: Initialize streaming connection
            logger.info("Phase 2: Connecting to Groq for streaming analysis")
            ...
            yield self._create_event('llm_start', {
                'message': f'Groq openai/gpt-oss-120b streaming analysis started',
                'model': 'openai/gpt-oss-120b',
                'streaming': True,
            ...
            structured_result = self._parse_classification_response(
                ...
                model_id='openai/gpt-oss-120b', model_preference=model_preference,
                analysis_depth=analysis_depth,
            )
...
• Date of Birth: {base_entity.get('dateOfBirth', 'Not provided')}"""
                ...
                if watchlist_matches:
                    ...
                    for match in watchlist_matches[:5]:  # Top 5 matches
                        ...
                        match_source = match.get('source', match.get('match_source', 'Unknown'))
