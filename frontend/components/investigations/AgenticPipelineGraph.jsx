  ...
  return (
    <div
      ...
      style={{
        ...
        position: 'relative',
        borderBottom: `1px solid ${execState === 'active' ? palette.blue.light1 : palette.gray.light2}`,
        borderLeft: `1px solid ${execState === 'active' ? palette.blue.light1 : palette.gray.light2}`,
        borderRight: `1px solid ${execState === 'active' ? palette.blue.light1 : palette.gray.light2}`,
...
function WorkerNode({ data }) {
  ...
  return (
    <div style={{
      ...
      filter: 'drop-shadow(0 2px 6px rgba(20, 23, 26, 0.08))',
      borderTop: `1px dashed ${execState === 'active' ? palette.blue.light1 : palette.purple.light1}`,
      borderBottom: `1px dashed ${execState === 'active' ? palette.blue.light1 : palette.purple.light1}`,
      borderRight: `1px dashed ${execState === 'active' ? palette.blue.light1 : palette.purple.light1}`,
        ...
        {LEGEND_ITEMS.map(item => (
          <div key={item.label} style={{
            ...
            <div style={{
              ...
              background: item.bg,
              borderBottom: item.border || 'none',
              borderLeft: item.border || 'none',
              borderRight: item.border || 'none',
