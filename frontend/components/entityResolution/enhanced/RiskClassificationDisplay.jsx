        ...
        {suspiciousIndicators.map((indicator, index) => (
          <Card key={index} style={{ 
            ...
            <div style={{ display: 'flex', gap: spacing[2] }}>
              <Icon glyph="ImportantWithCircle" style={{ color: palette.red.base, marginTop: '2px' }} size={16} />
              <div style={{ flex: 1 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: spacing[2] }}>
        {allRecommendations.map((rec, index) => (
          <Card key={index} style={{ 
            ...
            <div style={{ display: 'flex', gap: spacing[2] }}>
              <Icon glyph="Recommended" style={{ color: palette.blue.base, marginTop: '2px' }} size={16} />
              <div style={{ flex: 1 }}>
                <Body weight="medium" style={{ fontSize: '15px', marginBottom: spacing[2], fontWeight: '600' }}>
        ...
        <Card style={{ padding: spacing[4] }}>
          ...
          >
            <H3 style={{ 
              ...
              <Icon glyph="Recommended" style={{ color: palette.blue.base }} />
