        ...
        <ErrorBoundary>
          {streamingState.finalResult ? (
            <>
              ...
              <Card style={{ marginBottom: spacing[4] }}>
                <Tabs selected={selectedTab} setSelected={setSelectedTab} aria-label="Classification Tabs">
...
function RawResponseDisplay({ rawText, responseLength = 0 }) {
  if (!rawText) {
    return (
      <div style={{ textAlign: 'center', padding: spacing[4] }}>
        <Icon glyph="InfoWithCircle" style={{ color: palette.gray.base, marginBottom: spacing[2] }} />
